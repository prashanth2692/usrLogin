  ...
  created: function () {
    ...
    axios.get('/charts/bpl')
      .then((res) => {
        ...
        // let fusionTable = fusionDataStore.createDataTable(res.data, schema);

        //attempt 1
        // var dataStore = (new FusionCharts.DataStore(res.data, [{
        //   "name": "Date",
        //   "type": "date",
        //   "format": "%yyyy/%m%d"
        // }, {
        ...
        var layout = {
          ...
          yaxis: {
            autorange: true, 
            domain: [0, 1], 
            range: [50, 137.410004222], 
            type: 'linear'
          }
        };
        
        Plotly.plot('chartcontainer', data, layout);
      })
      .catch(function (err) {
        console.log(err)
      })
