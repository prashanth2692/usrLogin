...
response = requests.get("https://kite.zerodha.com/oms/instruments/historical/884737/day?user_id=YE1705&oi=1&from=2018-10-07&to=2020-04-07&ciqrandom=1617945495741",
                        headers={
                            "accept": "*/*",
...
panda_df = pd.DataFrame(data=candles_np[:, 1:], index=candles_np[:, 0], columns=[
